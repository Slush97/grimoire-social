...
//
// This file is the seed of the future @grimoire/social-types npm package.
// Until it's extracted, the Electron client should import from here via
// path alias or copy with a CI diff check.
//
...
// to its in-memory list without refetching (D1 read-after-write — see §8.2).
